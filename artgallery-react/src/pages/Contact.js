          ...
          <div className="row">
            ...
            <div className="row mt-2">
              ...
              <div className="col-md-3">
                ...
                <blockquote className="twitter-tweet" data-width="350">
                  <p lang="en" dir="ltr">
                    Goya - The Colossus 
                    <a href="https://t.co/RW7Ybx5Ub6">pic.twitter.com/RW7Ybx5Ub6</a>
                  </p>
                  &mdash; Art Gallery (@X_ArtGallery) 
                  <a href="https://twitter.com/X_ArtGallery/status/1958595553253786069">
                    August 21, 2025
                  </a>
                </blockquote>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 fade-in">
              ...
              <ul className="list-unstyled" style={{color: 'aliceblue'}}>
                <li><strong>📍 Address:</strong> कलामृत Ahmedabad, Commerce Six Road</li>
                <li><strong>📞 Phone:</strong> +91 9874679381</li>
                <li><strong>📧 Email:</strong> contact@kalamrutartgallery.com</li>
              </ul>
